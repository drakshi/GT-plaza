...
class AfterSidebar extends React.Component {

    render() {
        return (
            <>
                <div className="col-12 log_account after-menu">
                    <ul>
                        <li>
                            ...
                            <Link href={"/user/products"}>
                                <a>
                                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cube"
                                         ...
                                         className="svg-inline--fa fa-cube fa-w-16 fa-3x">
                                        <path fill="currentColor"
