        ...
        return(
            <>
                ...
                <div className="col-12 banner">
                    <img src={images.feedback.default.src} width="780" height="280" data-cfasync=" false"  alt=""/>
                    <div className="text">
                        <h3>Any feedback ?</h3>
                    ...
                    <div className="col-12 form">
                        <div className="row justify-content-center">
                                    ...
                                    <div className="col-12">
                                        <div className="row">
                                            ...
                                            <div className="col-12 form-group mb-2 w-100 checkbox">
                                                ...
                                                <p className="mx-2 text-start" style={{color:'red'}}>*All fields are mandatory to
                                                    fill</p>
                                                <div className="col-12 form-group text-center">
                                                    <button type="submit" className="btn" onClick={(e) => {this.handleSubmit(e)}}>Submit</button>
                                                </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div className="col-md-3 col-12 right ads">
                                <div className="col-12 t-box" id="feedback-banner-holder">
