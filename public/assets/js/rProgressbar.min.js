    ...
    $.fn.rProgressbar = function(options) {
        ...
        return this.each(function(index, el) {
            ...
            var lineProgressBarInit = function() {
                ...
                progressFill.animate({ width: options.percentage + "%" }, { step: function(x) { if (options.ShowProgressCount) { $(el).find(".percentCount").text("$"+options.amount); } }, duration: options.duration });
            }
